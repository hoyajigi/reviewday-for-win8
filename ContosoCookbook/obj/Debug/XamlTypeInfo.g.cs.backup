...
using ContosoCookbook.ContosoCookbook_XamlTypeInfo;
...
namespace ContosoCookbook.ContosoCookbook_XamlTypeInfo
{
    ...
    internal partial class XamlTypeInfoProvider
    {
        ...
        private object Activate_0_AboutUserControl() { return new ContosoCookbook.AboutUserControl(); }

        private object Activate_1_LayoutAwarePage() { return new ContosoCookbook.Common.LayoutAwarePage(); }

        private object Activate_2_BooleanToVisibilityConverter() { return new ContosoCookbook.Common.BooleanToVisibilityConverter(); }

        private object Activate_3_SearchResultsPage() { return new ContosoCookbook.SearchResultsPage(); }

        private object Activate_4_GroupedItemsPage() { return new ContosoCookbook.GroupedItemsPage(); }

        private object Activate_5_GroupDetailPage() { return new ContosoCookbook.GroupDetailPage(); }

        private object Activate_6_ListConverter() { return new ContosoCookbook.Common.ListConverter(); }

        private object Activate_7_ItemDetailPage() { return new ContosoCookbook.ItemDetailPage(); }
        ...
        private IXamlType CreateXamlType(string typeName)
        {
            ...
            case "ContosoCookbook.AboutUserControl":
                userType = new XamlUserType(this, typeName, typeof(ContosoCookbook.AboutUserControl), GetXamlTypeByName("Windows.UI.Xaml.Controls.UserControl"));
                userType.Activator = Activate_0_AboutUserControl;
                xamlType = userType;
                break;

            case "ContosoCookbook.Common.LayoutAwarePage":
                userType = new XamlUserType(this, typeName, typeof(ContosoCookbook.Common.LayoutAwarePage), GetXamlTypeByName("Windows.UI.Xaml.Controls.Page"));
                userType.Activator = Activate_1_LayoutAwarePage;
                xamlType = userType;
                break;

            case "ContosoCookbook.Common.BooleanToVisibilityConverter":
                userType = new XamlUserType(this, typeName, typeof(ContosoCookbook.Common.BooleanToVisibilityConverter), GetXamlTypeByName("Object"));
                userType.Activator = Activate_2_BooleanToVisibilityConverter;
                xamlType = userType;
                break;

            case "ContosoCookbook.SearchResultsPage":
                userType = new XamlUserType(this, typeName, typeof(ContosoCookbook.SearchResultsPage), GetXamlTypeByName("ContosoCookbook.Common.LayoutAwarePage"));
                userType.Activator = Activate_3_SearchResultsPage;
                xamlType = userType;
                break;

            case "ContosoCookbook.GroupedItemsPage":
                userType = new XamlUserType(this, typeName, typeof(ContosoCookbook.GroupedItemsPage), GetXamlTypeByName("ContosoCookbook.Common.LayoutAwarePage"));
                userType.Activator = Activate_4_GroupedItemsPage;
                xamlType = userType;
                break;

            case "ContosoCookbook.GroupDetailPage":
                userType = new XamlUserType(this, typeName, typeof(ContosoCookbook.GroupDetailPage), GetXamlTypeByName("ContosoCookbook.Common.LayoutAwarePage"));
                userType.Activator = Activate_5_GroupDetailPage;
                xamlType = userType;
                break;

            case "ContosoCookbook.Common.ListConverter":
                userType = new XamlUserType(this, typeName, typeof(ContosoCookbook.Common.ListConverter), GetXamlTypeByName("Object"));
                userType.Activator = Activate_6_ListConverter;
                xamlType = userType;
                break;

            case "ContosoCookbook.ItemDetailPage":
                userType = new XamlUserType(this, typeName, typeof(ContosoCookbook.ItemDetailPage), GetXamlTypeByName("ContosoCookbook.Common.LayoutAwarePage"));
